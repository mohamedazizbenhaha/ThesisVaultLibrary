    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(`Error: ${error.error || 'Failed to add thesis'}`);
            }
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] pb-20">
                ...
                <div className="max-w-5xl mx-auto px-6 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-black text-gray-900 tracking-tight">Add New Research</h1>
                                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600">Laboratory Entry</p>
                            </div>
                        </div>
                        <button
                            form="add-thesis-form"
                            type="submit"
                        ...
                        >
                            {loading ? 'Processing...' : <><Save size={16} /> Save Record</>}
                        </button>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-5xl mx-auto px-6 py-12">
                <form id="add-thesis-form" onSubmit={handleSubmit} className="space-y-12">
                    {/* Basic Info Section */}
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Enter a brief summary of the research..."
                                />
                            </div>

                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Research Fields (Select all that apply)</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Graduation Year</label>
                                    <input
                                        type="number"
                                        required
                                        value={formData.year}
